...
def _header_footer(canvas, doc, topic: str):
    ...
    canvas.drawString(20 * mm, height - 12 * mm, "N.O.V.A Document")
    canvas.drawRightString(width - 20 * mm, height - 12 * mm, topic)
    ...
    canvas.drawRightString(
        width - 20 * mm, 10 * mm,
        f"Generated by N.O.V.A | {date_str}"
    )
...
def preprocess_content(text: str) -> list:
    ...
    for line in lines:
        ...
        if line.startswith('## '):
            ...
            flowables.append(Paragraph(line[2:], styles['heading']))
